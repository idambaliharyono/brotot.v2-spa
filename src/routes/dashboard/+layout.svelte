...
{#if dataLoaded && $user}
  ...
  <div class="lg:hidden">
    <div class="p-4">
      ...
      <div class="dock bg-neutral text-neutral-content fixed bottom-0 left-0 right-0 z-20">
        <!-- ... your dock buttons ... -->
  ...
  <button onclick={()=>goto('/dashboard/members2')} class:dock-active={$page.url.pathname === '/dashboard/members2'}>
