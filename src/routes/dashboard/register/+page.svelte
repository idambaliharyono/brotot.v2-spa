        ...
        <div class="flex items-center justify-between mt-6">
            {#each [1, 2, 3] as s}
                <div class="flex-1 flex flex-col items-center relative">
                    ...
                    <!-- Step Circle -->
                    <div class={`w-6 h-6 rounded-full flex items-center justify-center mb-3 z-10 border-2 ${step >= s ? 'border-blue-500 bg-blue-500 text-white' : 'border-gray-700 bg-gray-800 text-gray-400'}`}>
                        {#if step > s}
